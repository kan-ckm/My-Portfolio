    ...
    return (
        <div className='py-20' id='projects'>
            <h1 className='heading'>
                ...
                <span className='text-purple-200'>renct projects</span>
            </h1>
                ...
                {projects.map(({ id, title, des, img, iconLists, link }) => (
                    <div key={id} className='lg:min-h-[32.5rem] h-[32rem] sm:h-[41rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
                        <PinContainer title={link} href={link}>
                            <div className='relative flex items-center justify-center sm:w-[570px] sm:h-[40vh] w-[80vw] overflow-hidden h-[30vh] lg:h-[49vh] mb-10'>
                                <div className='relative w-full h-full  overflow-hidden lg:rounded-3xl bg-[#13162d]'>
                                    <img src="/bg.png" alt="img" />
                                    <img src={img} alt={title} className='z-10 absolute bottom-0 left-1/2 transform -translate-x-1/2' />
                                </div>
                            </div>
                            ...
                            <div className='flex items-center justify-between mt-7 mb-3'>
                                ...
                                <div className='flex justify-center items-center'>
                                    ...
                                    <FaLocationArrow className='ms-3 text-purple-200' />
                                </div>
