...
const Hero = () => {
    return (
        <div className=' pb-20 pt-36'>
            ...
            <div className=" relative   h-82 w-full items-center justify-center bg-white dark:bg-[#000319]  top-0 left-0">
                <div
                    className={cn(
                        " absolute inset-0",
                ...
                <div className=' flex justify-center relative my-20 z-10'>
                    <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                        ...
                        <TextGenerateEffect
                            ...
                            words='Transforming Concepts into Seamless User Sealess Experiences'
                        />
                        <p className=' text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                            Hi, I&apos;m Kan-kcm, a Next.js Developer in Bach Nghe.
                        </p>
                        <a href='#about'>
                            <MagicButton
